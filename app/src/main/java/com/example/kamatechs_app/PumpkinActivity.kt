...
import com.example.kamatechs_app.databinding.ActivityPumpkinBinding

class PumpkinActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = DataBindingUtil.setContentView<ActivityPumpkinBinding>(this, R.layout.activity_pumpkin)
