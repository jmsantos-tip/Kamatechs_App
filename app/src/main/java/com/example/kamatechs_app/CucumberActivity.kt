...
import com.example.kamatechs_app.databinding.ActivityCucumberBinding
import com.google.firebase.auth.FirebaseAuth

class CucumberActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = DataBindingUtil.setContentView<ActivityCucumberBinding>(this, R.layout.activity_cucumber)
