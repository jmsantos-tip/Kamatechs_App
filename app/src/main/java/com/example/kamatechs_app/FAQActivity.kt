...
import com.example.kamatechs_app.databinding.ActivityFaqBinding
...
class FAQActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<ActivityFaqBinding>(this, R.layout.activity_faq)
