...
import com.example.kamatechs_app.databinding.ActivityCoconutBinding
...
class CoconutActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<ActivityCoconutBinding>(this, R.layout.activity_coconut)
