...
import com.example.kamatechs_app.databinding.ActivityGingerRootBinding
import com.google.firebase.auth.FirebaseAuth

class GingerRootActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = DataBindingUtil.setContentView<ActivityGingerRootBinding>(this, R.layout.activity_ginger_root)
