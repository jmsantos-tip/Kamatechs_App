...
import com.example.kamatechs_app.databinding.ActivityDevelopersBinding
...
class DevelopersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<ActivityDevelopersBinding>(this, R.layout.activity_developers)
